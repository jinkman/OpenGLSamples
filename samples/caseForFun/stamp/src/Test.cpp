...
int main()
{
	...
	bindFace(0, 7);
	////上部
	readFace(vArr[0], vec2(0.0, 0.0), vArr[4], vec2(0.0, 0.0), vArr[5], vec2(0.0, 0.0)); // 0 4 5 三角形
	bindFace(1, 14);
	...
	bindFace(2, 6);
	readFace(vArr[1], vec2(0.0, 0.0), vArr[6], vec2(0.0, 0.0), vArr[7], vec2(0.0, 0.0)); // 1 6 7 三角形
	bindFace(3, 14);
	...
	bindFace(4, 14);
	readFace(vArr[2], vec2(0.0, 0.0), vArr[8], vec2(0.0, 0.0), vArr[9], vec2(0.0, 0.0)); // 2 8 9 三角形
	bindFace(5, 14);
	...
	bindFace(6, 9);
	readFace(vArr[3], vec2(0.0, 0.0), vArr[10], vec2(0.0, 0.0), vArr[11], vec2(0.0, 0.0)); // 3 10 11 三角形
	bindFace(7, 14);
	...
	bindFace(16, 3);
	//下部
	readFace(vArr[12], vec2(0.0, 0.0), vArr[20], vec2(0.0, 0.0), vArr[13], vec2(0.0, 0.0)); // 12 20 13	三角形
	bindFace(17, 14);
	...
	bindFace(18, 13);
	readFace(vArr[14], vec2(0.0, 0.0), vArr[21], vec2(0.0, 0.0), vArr[15], vec2(0.0, 0.0)); // 14 21 15	三角形
	bindFace(19, 14);
	...
	bindFace(20, 14);
	readFace(vArr[16], vec2(0.0, 0.0), vArr[22], vec2(0.0, 0.0), vArr[17], vec2(0.0, 0.0)); // 16 22 17	三角形
	bindFace(21, 14);
	...
	bindFace(22, 11);
	readFace(vArr[18], vec2(0.0, 0.0), vArr[23], vec2(0.0, 0.0), vArr[19], vec2(0.0, 0.0)); // 18 23 19	三角形
	bindFace(23, 14);
