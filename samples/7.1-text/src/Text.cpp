...
int main()
{
	...
	if (FT_New_Face(ft, "字体.ttf", 0, &face))
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//绘制字体
		RenderText(shader, L"天空中没有鸟的痕迹", -2.0f, 0.5f, 0.001f, glm::vec3(0.5, 0.8f, 0.2f));
		RenderText(shader, L"但我已飞过", -2.0f, 0.0f, 0.001f, glm::vec3(0.3, 0.7f, 0.9f));
