...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glm::mat4 projection = glm::perspective(camera.Zoom, (GLfloat)scrWidth / (GLfloat)scrHeight, 0.1f, 100.0f);
        ...
        for (GLuint i = 0; i < lightPositions.size(); i++) {
            shaderLightingPass.setVec3("lights[" + std::to_string(long(i)) + "].Position", lightPositions[i]);
            shaderLightingPass.setVec3("lights[" + std::to_string(long(i)) + "].Color", lightColors[i]);

            const GLfloat constant = 1.0f;
            const GLfloat linear = 0.7f;
            const GLfloat quadratic = 1.8f;
            shaderLightingPass.setFloat("lights[" + std::to_string(long(i)) + "].Linear", linear);
            shaderLightingPass.setFloat("lights[" + std::to_string(long(i)) + "].Quadratic", quadratic);
            ...
            shaderLightingPass.setFloat("lights[" + std::to_string(long(i)) + "].Radius", radius);
        }
